...
def usage():
    ...
    print('-c/--clips_dir=    <Directory of training clips, generated by process_data.py>')
...
def main():
    ...
    num_steps = 1000001
    try:
        opts, _ = getopt.getopt(sys.argv[1:], 'l:c:t:r:a:n:s:OTH',
                                ['load_path=', 'clips_dir=', 'test_dir=', 'recursions=', 'adversarial=', 'name=',
